...
public class MailController {
    ...
    /**
     * Method for sending mails to user`s email address for recovering password
     *
    ...
    public ResponseEntity<String> sendPasswordRecovery(@RequestParam String email) {
        ...
        try {
            ...
            if (user != null) {
                ...
                sender.sendMessageWithTextFromFile(user.getEmail(),
                        "Восстановление пароля: подтверждение",
                        "<p>Перейдите по следующей ссылке, чтобы создать " +
                                "новый пароль для входа в приложение Morse Translator:</p>" +
                                "<p></p> <p>" +
                                ROOT_URL + "/enter/change_password?sec_key=" +
                                user.getPassword().getSalt() + user.getId() +
                                "</p> <p> </p>" +
                                "<p>Если вы не регистрировались в приложении Morse Translator, " +
                                "то проигнорируйте данное сообщение</p>",
                        true
                );
    ...
    /**
     * Method for sending mails to user`s email address with new password
     *
        ...
        try {
            ...
            if (sec_key.contains(user.getPassword().getSalt())) {
                ...
                sender.sendMessageWithTextFromFile(user.getEmail(),
                        ...
                        "<p>Новый пароль для входа в приложение Morse Translator: " + newPassword +
                                "</p> <p></p>" +
                                "<p>Если вы не регистрировались в приложении Morse Translator, " +
                                "то проигнорируйте данное сообщение</p>",
                        true
